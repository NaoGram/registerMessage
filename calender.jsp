...
<body>
	<form method="post" action="/jsp/calendar.jsp">
		<ul>
			<li><input type="text" name="year" value="${request['year']}" /><label
				for="year">年</label><input type="text" name="month" value="${request['month']}" /><label for="month">月</label><input
				type="text" name="day" value="${request['day']}" />
